  ...
  root.innerHTML = `
    <div class="jumbotron jumbotron-fluid bd-hero mb-4">
      <div class="container-fluid">
        ...
        <div class="mt-4">
          <a href="/packet/" class="btn btn-outline-info mr-2">View Packets</a>
          <a href="/document/" class="btn btn-outline-secondary mr-2">View Documents</a>
          <a href="/news/" class="btn btn-outline-secondary mr-2">News</a>
        </div>
      </div>
    </div>
    <div class="container-fluid">
